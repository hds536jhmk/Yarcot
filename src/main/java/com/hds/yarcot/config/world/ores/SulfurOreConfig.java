...
public class SulfurOreConfig {
    ...
    public static void pushConfig(ForgeConfigSpec.Builder builder) {
        OreConfigBuilder.pushCategory(builder, "sulfur_ore");

        rarity = OreConfigBuilder.defineRarity(builder, 25);
        veinSize = OreConfigBuilder.defineVeinSize(builder, 3);
        lowestSpawnHeight = OreConfigBuilder.defineLowestSpawnHeight(builder, 10);
        highestSpawnHeight = OreConfigBuilder.defineHighestSpawnHeight(builder, 40);
